...
<body>
	<section class="container-fluid">
		<?php $alias="date"; require_once 'html/navbar.php';?>
	</section>
	<!-- section titulo -->
	<section class="container-fluid bg-light">
		<div class="wrap-footer text-center">
			<?php #section tittle
				if ($m=="R") { #TittleRead
					print '<h3>Citas pendientes</h3>';
				}#end TittleRead
				else if ($m=="C") { #TittleCreate
					print '<h3>Agendar citas</h3>';
				} #end TittleCreate
				else if ($m=="U") { #TittleUpdate
					print '<h3>Gestionar citas</h3>';
				} #end TittleUpdate
			?>
		</div>
	</section>
					...
					<div class="form-group text-right">
						...
						if ($m == "U") {
							?>
								...
								<!-- Button  -->
								<a href=<?php print 'visit.php?m=U&id='.$id.'code='.$code; ?> class="btn btn-outline-warning" role="button" aria-pressed="true">Registrar Visita</a>
							<?php 
						}else{
						?>
							<label for="enviar"></label>
